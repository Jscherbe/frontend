// Version:         1.0.1
// Changes:         1.0.1 | Added optional resizable (allowResize)
...
export function setupModal(modal, settings) {
  ...
  const resizerMarkup = notCenter && allowResize ? `<div class="${ classes.resizer }"></div>` : '';
  ...
  const markup = `
    ...
    >
      <div class="site-modal__overlay" tabindex="-1" data-site-modal-close>
        <div class="site-modal__container" role="dialog" aria-modal="true" aria-labelledby="${ id }-title">
          <div class="site-modal__header">
            ...
            <button class="site-modal__close" aria-label="Close modal" data-site-modal-close>
              <span class="fas fa-times" aria-hidden="true" data-site-modal-close></span>
            </button>
          </div>
