...
export class OverflowScroller {
  ...
  constructor(elements, config) {
    ...
    document.addEventListener(getCoreEventName("pageResized"), this.updateHandler);
    document.addEventListener(getCoreEventName("pageModified"), this.updateHandler);
  ...
  destroy() {
    this.elements.track.removeEventListener("scroll", this.scrollHandler);
    document.removeEventListener(getCoreEventName("pageResized"), this.updateHandler);
    document.removeEventListener(getCoreEventName("pageModified"), this.updateHandler);
